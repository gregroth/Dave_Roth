function [t,x]=single_rna_probaribo_flux(kon,koff,delta,exportrate,initiationrate,tmax,initialcondition)
%   Gregory Roth, 2022
...
%% Run simulation
[t,x]=directMethod_probaribo_flux(stoich_matrix, prop, tspan, x0, p,4,delta);
end
